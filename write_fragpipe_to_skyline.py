...
def main():
    ...
    with open(os.path.join(dir_path, "filelist_proteinprophet.txt"), "r") as file:
        filenames = [line.rstrip().split("-")[-1].split(".")[0] for line in file]
    ...
    subs_table = pd.read_csv("W:/Nicola/Scripts/my_scripts/fragpipe_to_skyline/Substitution_matrix_v241104.csv", index_col = 0)
